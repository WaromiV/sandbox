              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {data.budgets.activeIncidents} {data.budgets.activeIncidents === 1 ? t("active budget incident") : t("active budget incidents")}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {data.budgets.pausedAgents} {t("agents paused")} · {data.budgets.pausedProjects} {t("projects paused")} · {data.budgets.pendingApprovals} {t("pending budget approvals")}
                  </p>
                </div>
              </div>
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `${data.costs.monthUtilizationPercent}% ${t("of budget")} ${formatCents(data.costs.monthBudgetCents)}`
                    : t("Unlimited budget")}
                </span>
              }
            />
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? `${data.budgets.pendingApprovals} ${t("budget overrides awaiting board review")}`
