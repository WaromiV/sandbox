          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              ...
              <Field
                ...
                hint={`${t("Accepted range:")} 1-${MAX_COMPANY_ATTACHMENT_MAX_MIB} MiB.`}
              >
                <div className="flex flex-col gap-1.5">
                  ...
                  {!attachmentMaxValid && (
                    <span className="text-xs text-destructive">
                      {t("Enter a whole number from 1 to")} {MAX_COMPANY_ATTACHMENT_MAX_MIB}.
                    </span>
                  )}
                </div>
              </Field>
            ...
            <Button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  `${t("Archive company")} "${selectedCompany.name}"? ${t("It will be hidden from the sidebar.")}`
                );
                if (!confirmed) return;
                const nextCompanyId =
                  companies.find(
