...
export const typeLabel: Record<string, string> = {
  hire_agent: t("Hire Agent"),
  approve_ceo_strategy: t("CEO Strategy"),
  budget_override_required: t("Budget Override"),
  request_board_approval: t("Board Approval"),
};
...
export function BudgetOverridePayload({ payload }: { payload: Record<string, unknown> }) {
  ...
  return (
    <div className="mt-3 space-y-1.5 text-sm">
      <PayloadField label={t("Scope")} value={payload.scopeName ?? payload.scopeType} />
      <PayloadField label={t("Window")} value={payload.windowKind} />
      <PayloadField label={t("Metric")} value={payload.metric} />
