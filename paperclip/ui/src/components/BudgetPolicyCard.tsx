    ...
    <div className="grid gap-6 sm:grid-cols-2">
      <div>
        ...
        <div className="mt-1 text-xs text-muted-foreground">
          {summary.amount > 0 ? `${summary.utilizationPercent}% ${t("of limit")}` : t("No cap configured")}
        </div>
      </div>
      <div>
        ...
        <div className="mt-1 text-xs text-muted-foreground">
          {t("Soft alert at")} {summary.warnPercent}%{summary.paused && summary.pauseReason ? ` · ${t("pause:")} ${summary.pauseReason}` : ""}
        </div>
      </div>
    </div>
  ) : (
