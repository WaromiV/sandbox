      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="break-words">
            {t("Archive")} <span className="font-medium text-foreground">{workspaceName}</span> {t("and clean up any owned workspace artifacts. Paperclip keeps the workspace record and issue history, but removes it from active workspace views.")}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            {blockingIssues.length > 0 ? (
              <section className="space-y-2">
                <h3 className="text-sm font-medium">{t("Blocking issues")}</h3>
            ...
            {readiness.blockingReasons.length > 0 ? (
              <section className="space-y-2">
                <h3 className="text-sm font-medium">{t("Blocking reasons")}</h3>
                ...
                <div className="rounded-xl border border-border bg-background px-4 py-3 text-sm">
                  <div className="grid gap-2 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <div className="font-mono text-xs">{readiness.git.baseRef ?? t("Not set")}</div>
                    </div>
                    <div>
            ...
            {otherLinkedIssues.length > 0 ? (
              <section className="space-y-2">
                <h3 className="text-sm font-medium">{t("Other linked issues")}</h3>
                <div className="space-y-2">
            ...
            {readiness.runtimeServices.length > 0 ? (
              <section className="space-y-2">
                <h3 className="text-sm font-medium">{t("Attached runtime services")}</h3>
                <div className="space-y-2">
            ...
            <section className="space-y-2">
              <h3 className="text-sm font-medium">{t("Cleanup actions")}</h3>
              <div className="space-y-2">
            ...
            <div className="text-xs text-muted-foreground">
              {t("Last checked")} {formatDateTime(new Date())}
            </div>
          </div>
        ) : null}
