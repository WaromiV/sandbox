...
export const AgentParamsSchema = Type.Object(
  {
    ...
    // Opaque metadata attached by the paperclip openclaw_gateway adapter
    // (workspace hints, run id, etc.). Treated as an opaque envelope by
    // openclaw — useful for downstream tooling that inspects gateway
    // requests but ignored by the agent run path.
