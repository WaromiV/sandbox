...
const lazyEditor = createLazyView(() => import("./views/editor.ts"), notifyLazyViewChanged);
const lazyInstances = createLazyView(() => import("./views/instances.ts"), notifyLazyViewChanged);
const lazyIssues = createLazyView(() => import("./views/issues.ts"), notifyLazyViewChanged);
...
export function renderApp(state: AppViewState) {
  ...
  const isIframeTab = state.tab === "issues" || state.tab === "editor";
  ...
  return html`
    ...
    >
      ...
      <main
        class="content ${isChat ? "content--chat" : ""} ${isIframeTab ? "content--iframe-tab" : ""}"
      >
        ...
        ${state.tab === "issues"
          ? renderLazyView(lazyIssues, (m) =>
              m.renderIssues({ themeMode: state.themeResolved, themeName: state.theme }),
            )
          : nothing}
        ${state.tab === "editor"
          ? renderLazyView(lazyEditor, (m) =>
              m.renderEditor({
                themeMode: state.themeResolved,
                themeName: state.theme,
                selectedAgentId: state.editorWorkspaceId,
